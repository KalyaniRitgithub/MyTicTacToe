...
private void drawWinningLine(Canvas canvas){
        ...
        public void  setUpGame(Button button3, Button button4, TextView  textView,String[] names){
game.setPlayAgainBTN(button3);
game.setHomeBtn(button4);
game.setPlayerTurn(textView);
